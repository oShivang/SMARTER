...
class Config:
    ...
    system_prompt: str = "Solve the following math problem efficiently and clearly. Separate each reasoning step with exactly two newlines (\\n\\n).\n\n- For simple problems (2 steps or fewer):\nProvide a concise solution with minimal explanation.\n\n- For complex problems (3 steps or more):\nUse this step-by-step format:\n\n## Step 1: [Concise description]\n[Brief explanation and calculations]\n\n## Step 2: [Concise description]\n[Brief explanation and calculations]\n\n...\n\nRegardless of the approach, always conclude with:\n\nTherefore, the final answer is: $\\boxed{answer}$. I hope it is correct.\n\nWhere [answer] is just the final number or expression that solves the problem."
    ...
    def __post_init__(self):
        ...
        if self.approach == "beam_search":
            ...
            if self.search_batch_size != 1:
                import warnings
                warnings.warn(f"search_batch_size {self.search_batch_size} is not supported for beam_search. Setting it to 1.")
